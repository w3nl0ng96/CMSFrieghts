<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistoryLog.aspx.cs" Inherits="CMSFrieghts.HistoryLog" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="margin-top:20px;">
    <asp:GridView ID="History" runat="server" DataSourceID="CMSFreights" CssClass="table table-striped table-bordered table-condensed"
        AutoGenerateColumns="False" DataKeyNames="shipping_id" Height="119px" Width="1170px">
        <Columns>
...
<asp:SqlDataSource ID="CMSFreights" runat="server" ConnectionString="<%$ ConnectionStrings:CMSFrieghts2018DDAC_dbConnectionString %>" SelectCommand="SELECT * FROM [CustomerShipping] where status = 'Received'"></asp:SqlDataSource>
</asp:Content>
